1.	Написать программу проверки бинарных деревьев на изоморфность, используя обходы бинарных деревьев.  Варианты заданий указаны в таблице 1. Дерево задано списком ребер. Корнем дерева является вершина a.<br>
