1.	 Написать программу нахождения компонент сильной связности орграфа   . Варианты заданий указаны в таблице 1. Орграф задан списком дуг. Изобразить граф, пометив  его компоненты сильной связности.<br>
