**Эта программа использует алгоритм градиентного спуска для поиска оптимальных значений весовых коэффициентов, связанных с предсказанием оценок студентов на основе входных данных.**<br><br>
